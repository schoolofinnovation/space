...
<html lang="en" dir="">
  ...
  <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- Font -->
    <link href="{{asset('assets/elements/css2')}}" rel="stylesheet">

    <!-- CSS Implementing Plugins -->
    <link rel="stylesheet" href="{{asset('assets/elements/vendor.min.css')}}">
    ...
    <!-- CSS Space Template -->
    <link rel="stylesheet" href="{{asset('assets/elements/theme.min.css')}}">
  ...
  <script src="{{asset('assets/elements/clipboard.min.js')}}"></script>
  @livewireStyles
</head>
  ...
  <body data-new-gr-c-s-check-loaded="14.1063.0" data-gr-ext-installed="">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body p-sm-5">
            <!-- Log in -->
            <div id="signupModalFormLogin" style="display: none; opacity: 0;" data-hs-show-animation-target-group="idForm">
              <!-- Heading -->
              <div class="text-center mb-7">
                ...
                <p>Don't have an account yet?
                  <a class="js-animation-link" href="javascript:;" role="button" data-hs-show-animation-options="{
                           ...
                           &quot;groupName&quot;: &quot;idForm&quot;
                         }" data-hs-show-animation-link-group="idForm">Sign up here</a>
                </p>
              </div>
              <!-- End Heading -->

              <div class="d-grid gap-2">
                <a class="btn btn-white btn-lg" href="https://htmlstream.com/space/index.html#">
                    <span class="d-flex justify-content-center align-items-center">
                      <img class="avatar avatar-xss me-2" src="./Corporate _ Space - Multipurpose Responsive Template_files/google-icon.svg" alt="Image Description">
                      Log in with Google
                    </span>
                </a>

                <a class="js-animation-link btn btn-primary btn-lg" href="https://htmlstream.com/space/index.html#" data-hs-show-animation-options="{
            ...
            <!-- Log in with Modal -->
            <div id="signupModalFormLoginWithEmail" style="display: none; opacity: 0;" data-hs-show-animation-target-group="idForm">
              <!-- Heading -->
              <div class="text-center mb-7">
                <h4>Log in</h4>
                <p>Don't have an account yet?
            ...
            <div id="signupModalFormSignup" data-hs-show-animation-target-group="idForm">
              ...
              <div class="text-center mb-7">
                ...
                <p>Already have an account?
                  <a class="js-animation-link" href="javascript:;" role="button" data-hs-show-animation-options="{
                           ...
                           &quot;groupName&quot;: &quot;idForm&quot;
                         }" data-hs-show-animation-link-group="idForm">Log in here</a>
                </p>
              </div>
              <!-- End Heading -->
              ...
              <div class="d-grid gap-3">
                ...
                <div class="text-center">
                  <p class="small mb-0">By continuing you agree to our <a href="https://htmlstream.com/space/page-terms.html">Terms and Conditions</a></p>
                </div>
              </div>
            </div>
            <!-- End Sign up -->
            ...
            <!-- Sign up with Modal -->
            <div id="signupModalFormSignupWithEmail" style="display: none; opacity: 0;" data-hs-show-animation-target-group="idForm">
              <!-- Heading -->
              <div class="text-center mb-7">
                <h4>Sign up</h4>
                <p>Already have an account?
              ...
              <form class="js-validate need-validate" novalidate="">
                ...
                <div class="text-center">
                  <p class="small mb-0">By continuing you agree to our <a href="https://htmlstream.com/space/index.html#">Terms and Conditions</a></p>
                </div>
              </form>
            </div>
            ...
            <!-- Reset Password -->
            <div id="signupModalFormResetPassword" style="display: none; opacity: 0;" data-hs-show-animation-target-group="idForm">
              <!-- Heading -->
              <div class="text-center mb-7">
          ...
          <div class="modal-footer d-block text-center py-sm-5">
            ...
            <div class="w-85 mx-auto">
              <div class="row justify-content-between">
                <div class="col">
                  <img class="img-fluid" src="{{asset('assets/svg/gitlab-gray.svg')}}" alt="Logo">
                </div>
                <!-- End Col -->

                <div class="col">
                  <img class="img-fluid" src="{{asset('assets/svg/fitbit-gray.svg')}}" alt="Logo">
                </div>
                <!-- End Col -->

                <div class="col">
                  <img class="img-fluid" src="{{asset('assets/svg/flow-xo-gray.svg')}}" alt="Logo">
                </div>
                <!-- End Col -->

                <div class="col">
                  <img class="img-fluid" src="{{asset('assets/svg/layar-gray.svg')}}" alt="Logo">
                </div>
                <!-- End Col -->
              </div>
            </div>
    ...
    <!-- Go To -->
    <a class="js-go-to go-to position-fixed animated fadeOutDown hs-go-to-prevent-event" href="javascript:;" style="visibility: hidden; right: 2rem;" data-hs-go-to-options="{
         &quot;offsetTop&quot;: 700,
         &quot;position&quot;: {
           &quot;init&quot;: {
             &quot;right&quot;: &quot;2rem&quot;
    ...
    <script src="{{asset('assets/elements/vendor.min.js')}}"></script>

    <!-- JS Space -->
    <script src="{{asset('assets/elements/theme.min.js')}}"></script>
