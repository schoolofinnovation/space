<main id="content" role="main">
      ...
      <div class="bg-primary-dark position-relative overflow-hidden">
                  ...
                  <div class="card-body">
                    <div class="row align-items-sm-center mb-5">
                      <div class="col-sm-auto order-sm-2 mb-3 mb-sm-0">
                        <img class="avatar avatar-xxl avatar-4x3" src="{{asset('assets/svg/oc-chatting.svg')}}" alt="Image Description">
                      </div>
                      <!-- End Col -->
                    ...
                    <form>
                      ...
                      <div class="d-grid text-center">
                        ...
                        <span class="form-text">Need help? <a class="link" href="https://htmlstream.com/space/page-help-center.html">Visit our Help Center <i class="bi-chevron-right small ms-1"></i></a></span>
                      </div>
                    </form>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-sm mb-5 mb-sm-0">
              ...
              <div class="d-flex gap-1 mb-2">
                <img src="{{asset('assets/svg/star.svg')}}" alt="Review rating" width="16">
                <img src="{{asset('assets/svg/star.svg')}}" alt="Review rating" width="16">
                <img src="{{asset('assets/svg/star.svg')}}" alt="Review rating" width="16">
                <img src="{{asset('assets/svg/star.svg')}}" alt="Review rating" width="16">
                <img src="{{asset('assets/svg/star.svg')}}" alt="Review rating" width="16">
              ...
              <img class="avatar avatar-lg avatar-4x3" src="{{asset('assets/svg/amazon-white-50.svg')}}" alt="Logo">
            </div>
            <!-- End Col -->
            ...
            <div class="col-sm mb-5 mb-sm-0">
              ...
              <div class="d-flex gap-1 mb-2">
                ...
                <img src="{{asset('assets/svg/star.svg')}}" alt="Review rating" width="16">
                <img src="{{asset('assets/svg/star.svg')}}" alt="Review rating" width="16">
                <img src="{{asset('assets/svg/star-half.svg')}}" alt="Review rating" width="16">
              </div>
              <!-- End Rating -->

              <blockquote class="blockquote blockquote-sm text-white mb-4">“ The best template I've ever come across. ”</blockquote>

              <img class="avatar avatar-lg avatar-4x3" src="{{asset('assets/svg/airbnb-white-50.svg')}}" alt="Logo">
            </div>
            <!-- End Col -->
            ...
            <div class="col-sm mb-5">
              ...
              <img class="avatar avatar-lg avatar-4x3" src="{{asset('assets/svg/google-white-50.svg')}}" alt="Logo">
            </div>
            <!-- End Col -->
          </div>
          <!-- End Row -->
        ...
        <div class="position-absolute top-0 end-0">
          <img src="{{asset('assets/svg/shape-3-soft-light.svg')}}" alt="SVG" width="500">
        </div>
        <div class="position-absolute bottom-0 end-0 me-10">
          <img src="{{asset('assets/svg/shape-1-soft-light.svg')}}" alt="SVG" width="250">
        </div>
        <div class="position-absolute bottom-0 start-0">
          <img src="{{asset('assets/svg/shape-2-soft-light.svg')}}" alt="SVG" width="400">
        </div>
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-pills mb-7" id="featuresTab" role="tablist">
            <li class="nav-item" role="presentation">
              <a class="nav-link active" href="" id="featuresOne-tab" data-bs-toggle="tab" data-bs-target="#featuresOne" role="tab" aria-controls="featuresOne" aria-selected="true" style="width: 22rem;">
                <div class="d-flex">
                  <div class="flex-shrink-0">
            ...
            <li class="nav-item" role="presentation">
              <a class="nav-link" href="" id="featuresTwo-tab" data-bs-toggle="tab" data-bs-target="#featuresTwo" role="tab" aria-controls="featuresTwo" aria-selected="false" style="width: 22rem;">
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <span class="svg-icon svg-icon-sm text-primary">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg')}}">
            ...
            <li class="nav-item" role="presentation">
              <a class="nav-link" href="" id="featuresThree-tab" data-bs-toggle="tab" data-bs-target="#featuresThree" role="tab" aria-controls="featuresThree" aria-selected="false" style="width: 22rem;">
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <span class="svg-icon svg-icon-sm text-primary">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg')}}">
      ...
      <div class="container content-space-1 content-space-md-3">
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-4 mb-5">
            <span class="svg-icon text-primary mb-3">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg')}}">
              <path d="M13.0021 10.9128V3.01281C13.0021 2.41281 13.5021 1.91281 14.1021 2.01281C16.1021 2.21281 17.9021 3.11284 19.3021 4.61284C20.7021 6.01284 21.6021 7.91285 21.9021 9.81285C22.0021 10.4129 21.5021 10.9128 20.9021 10.9128H13.0021V10.9128Z" fill="#035A4B"></path>
              <path opacity="0.3" d="M11.0021 13.7128V4.91283C11.0021 4.31283 10.5021 3.81283 9.90208 3.91283C5.40208 4.51283 1.90209 8.41284 2.00209 13.1128C2.10209 18.0128 6.40208 22.0128 11.3021 21.9128C13.1021 21.8128 14.7021 21.3128 16.0021 20.4128C16.5021 20.1128 16.6021 19.3128 16.1021 18.9128L11.0021 13.7128Z" fill="#035A4B"></path>
              <path opacity="0.3" d="M21.9021 14.0128C21.7021 15.6128 21.1021 17.1128 20.1021 18.4128C19.7021 18.9128 19.0021 18.9128 18.6021 18.5128L13.0021 12.9128H20.9021C21.5021 12.9128 22.0021 13.4128 21.9021 14.0128Z" fill="#035A4B"></path>
              </svg>
          ...
          <div class="col-sm-6 col-lg-4 mb-5 mb-lg-0">
            <span class="svg-icon text-primary mb-3">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg')}}">
              <path opacity="0.3" d="M21 10.7192H3C2.4 10.7192 2 11.1192 2 11.7192C2 12.3192 2.4 12.7192 3 12.7192H6V14.7192C6 18.0192 8.7 20.7192 12 20.7192C15.3 20.7192 18 18.0192 18 14.7192V12.7192H21C21.6 12.7192 22 12.3192 22 11.7192C22 11.1192 21.6 10.7192 21 10.7192Z" fill="#035A4B"></path>
              <path d="M11.6 21.9192C11.4 21.9192 11.2 21.8192 11 21.7192C10.6 21.4192 10.5 20.7191 10.8 20.3191C11.7 19.1191 12.3 17.8191 12.7 16.3191C12.8 15.8191 13.4 15.4192 13.9 15.6192C14.4 15.7192 14.8 16.3191 14.6 16.8191C14.2 18.5191 13.4 20.1192 12.4 21.5192C12.2 21.7192 11.9 21.9192 11.6 21.9192ZM8.7 19.7192C10.2 18.1192 11 15.9192 11 13.7192V8.71917C11 8.11917 11.4 7.71917 12 7.71917C12.6 7.71917 13 8.11917 13 8.71917V13.0192C13 13.6192 13.4 14.0192 14 14.0192C14.6 14.0192 15 13.6192 15 13.0192V8.71917C15 7.01917 13.7 5.71917 12 5.71917C10.3 5.71917 9 7.01917 9 8.71917V13.7192C9 15.4192 8.4 17.1191 7.2 18.3191C6.8 18.7191 6.9 19.3192 7.3 19.7192C7.5 19.9192 7.7 20.0192 8 20.0192C8.3 20.0192 8.5 19.9192 8.7 19.7192ZM6 16.7192C6.5 16.7192 7 16.2192 7 15.7192V8.71917C7 8.11917 7.1 7.51918 7.3 6.91918C7.5 6.41918 7.2 5.8192 6.7 5.6192C6.2 5.4192 5.59999 5.71917 5.39999 6.21917C5.09999 7.01917 5 7.81917 5 8.71917V15.7192V15.8191C5 16.3191 5.5 16.7192 6 16.7192ZM9 4.71917C9.5 4.31917 10.1 4.11918 10.7 3.91918C11.2 3.81918 11.5 3.21917 11.4 2.71917C11.3 2.21917 10.7 1.91916 10.2 2.01916C9.4 2.21916 8.59999 2.6192 7.89999 3.1192C7.49999 3.4192 7.4 4.11916 7.7 4.51916C7.9 4.81916 8.2 4.91918 8.5 4.91918C8.6 4.91918 8.8 4.81917 9 4.71917ZM18.2 18.9192C18.7 17.2192 19 15.5192 19 13.7192V8.71917C19 5.71917 17.1 3.1192 14.3 2.1192C13.8 1.9192 13.2 2.21917 13 2.71917C12.8 3.21917 13.1 3.81916 13.6 4.01916C15.6 4.71916 17 6.61917 17 8.71917V13.7192C17 15.3192 16.8 16.8191 16.3 18.3191C16.1 18.8191 16.4 19.4192 16.9 19.6192C17 19.6192 17.1 19.6192 17.2 19.6192C17.7 19.6192 18 19.3192 18.2 18.9192Z" fill="#035A4B"></path>
              </svg>
          ...
          <div class="row align-items-md-center mb-5 mb-md-10">
            <div class="col-md-6 mb-5 mb-md-0">
              <div class="text-center">
                <img class="img-fluid" src="{{asset('assets/svg/oc-error.svg')}}" alt="Image Description" style="max-width: 20rem;">
              </div>
            </div>
            <!-- End Col -->
            ...
            <div class="col-md-6">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="row">Custom Fields <i class="bi-info-circle text-muted small ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Custom fields allow you to record additional information unique to your contacts, cases or sales opportunities." aria-label="Custom fields allow you to record additional information unique to your contacts, cases or sales opportunities."></i></th>
                    <td class="table-text-end">
                  ...
                  <tr>
                    <th scope="row">Activity Reporting <i class="bi-info-circle text-muted small ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Shows activities completed by each user and the specific activity types." aria-label="Shows activities completed by each user and the specific activity types."></i></th>
                    <td class="table-text-end">
                      <span class="svg-icon svg-icon-sm text-primary">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg')}}">
                        <path d="M17.738 6.35233C18.0957 5.93153 18.7268 5.88036 19.1476 6.23804C19.5684 6.59573 19.6196 7.22682 19.2619 7.64763L10.7619 17.6476C10.3986 18.075 9.75488 18.1201 9.33562 17.7474L4.83562 13.7474C4.42283 13.3805 4.38565 12.7484 4.75257 12.3356C5.11949 11.9228 5.75156 11.8857 6.16434 12.2526L9.90019 15.5733L17.738 6.35233Z" fill="#035A4B"></path>
                  ...
                  <tr>
                    <th scope="row">Two-Factor Authentication <i class="bi-info-circle text-muted small ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Add an extra layer of security to your Capsule Account using your mobile device." aria-label="Add an extra layer of security to your Capsule Account using your mobile device."></i></th>
                    <td class="table-text-end">
                      <span class="svg-icon svg-icon-sm text-primary">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg')}}">
                        <path d="M17.738 6.35233C18.0957 5.93153 18.7268 5.88036 19.1476 6.23804C19.5684 6.59573 19.6196 7.22682 19.2619 7.64763L10.7619 17.6476C10.3986 18.075 9.75488 18.1201 9.33562 17.7474L4.83562 13.7474C4.42283 13.3805 4.38565 12.7484 4.75257 12.3356C5.11949 11.9228 5.75156 11.8857 6.16434 12.2526L9.90019 15.5733L17.738 6.35233Z" fill="#035A4B"></path>
                  ...
                  <tr>
                    <th scope="row">API Access <i class="bi-info-circle text-muted small ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Use Capsule’s API to integrate with your custom or third party application." aria-label="Use Capsule’s API to integrate with your custom or third party application."></i></th>
                    <td class="table-text-end">
                      <span class="svg-icon svg-icon-sm text-muted">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg')}}">
                        <rect x="5.63602" y="16.9498" width="16" height="2" rx="1" transform="rotate(-45 5.63602 16.9498)" fill="#008060"></rect>
      ...
      <div class="bg-primary-dark">
        <div class="container content-space-b-1 content-space-t-2">
          ...
          <div class="row">
            <div class="col py-3">
              <img class="avatar avatar-xl avatar-4x3" src="{{asset('assets/svg/vidados-white.svg')}}" alt="Logo">
            </div>
            <!-- End Col -->

            <div class="col py-3">
              <img class="avatar avatar-xl avatar-4x3" src="{{asset('assets/svg/fitbit-white.svg')}}" alt="Logo">
            </div>
            <!-- End Col -->

            <div class="col py-3">
              <img class="avatar avatar-xl avatar-4x3" src="{{asset('assets/svg/forbes-white.svg')}}" alt="Logo">
            </div>
            <!-- End Col -->

            <div class="col py-3">
              <img class="avatar avatar-xl avatar-4x3" src="{{asset('assets/svg/mailchimp-white.svg')}}" alt="Logo">
            </div>
            <!-- End Col -->

            <div class="col py-3">
              <img class="avatar avatar-xl avatar-4x3" src="{{asset('assets/svg/layar-white.svg')}}" alt="Logo">
            </div>
            <!-- End Col -->
          </div>
          <!-- End Row -->
